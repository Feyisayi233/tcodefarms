      ...
      <section className="py-24 grain relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-20">
            {/* Table Eggs - Pulsing Gold Border */}
            <motion.div
            ...
            >
              <motion.div
                ...
                className="glass rounded-3xl overflow-hidden border-2 border-gold/50 hover-lift"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center glass-dark">
                    <div className="flex items-center gap-3 mb-6">
                      <Sparkles className="h-8 w-8 text-gold" />
                      <h2 className="text-4xl md:text-5xl font-bold gradient-text-gold">
                        Table Eggs
                      </h2>
                    </div>
                    ...
                    <div className="mb-8 p-6 glass rounded-2xl">
                      <p className="text-sm text-gray-400 mb-3">Price per crate (30 pieces):</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      >
                        <Button className="w-full sm:w-auto bg-gradient-to-r from-[#008751] to-[#00b366] hover:from-[#00b366] hover:to-[#008751] text-white border-0 shadow-lg">
                      ...
                      >
                        <Button variant="outline" className="w-full sm:w-auto border-gold text-gold hover:bg-gold hover:text-[#0a0a0a]">
                          Call to Order
                        </Button>
                      </motion.a>
                    </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center glass-dark order-1 md:order-2">
                  <div className="flex items-center gap-3 mb-6">
